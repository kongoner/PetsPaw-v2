...
export default function Layout() {
  ...
  const hero1x = isDarkMode ? '/images/girl-and-pet-light@1x.webp' : 'src/images/girl-and-pet@1x.webp';
  const hero2x = isDarkMode ? '/images/girl-and-pet-light@2x.webp' : 'src/images/girl-and-pet@2x.webp';
